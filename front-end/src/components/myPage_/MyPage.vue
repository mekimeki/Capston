<template>
  <v-container>
    <v-layout lign-start justify-start row fill-height pa-5 wrap>
      ...
      <v-flex pt-3 white xs12 sm12 md12>
        <template>
          <v-tabs color="white" icons-and-text>
            <v-tabs-slider color="red"></v-tabs-slider>
            <v-tab href="#tab-1">영상</v-tab>
            <v-tab href="#tab-2">성적</v-tab>
            <v-tab href="#tab-3">출석</v-tab>
            <v-tab href="#tab-4">개인정보</v-tab>
