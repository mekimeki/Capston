<template lang="html">
<div>
    <v-btn class="white--text" color="red lighten-1" small fab v-on:click="cut()">
        <span>CUT</span>
    </v-btn>
    <v-btn color="blue lighten-1" fab small v-on:click="click_play()">
        <v-icon color="white">
            play_arrow
        </v-icon>
    </v-btn>
    ...
    <div id="ranges">
        ...
        <span class="textCheck pr-2">START : </span><input class="input pl-2" type="text" name="" value="" v-model="video_firstTime" v-on:keyup="keyup_time_change($event,true)">
