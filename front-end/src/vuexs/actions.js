...
const actions = {
  video_action: ({
    commit
  }, payload) => { //video actions
    commit('video_mutation', payload);
  },
  video_link_action: ({
    commit
  }, payload) => { //video link action
    return service.video_link("api/video/edit/", payload);
  },
  subtitle_answer_action: ({
    commit
  }, payload) => { //subtitle answer action
    return service.subtitle_answer("api/subtitle/edit", payload);
  },
  subtitle_open_action: ({
    commit
  }, payload) => { //subtitle open action
